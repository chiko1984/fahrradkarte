...
map.getView().fit([1151714.047936, 6671571.175130, 1787984.047936, 7077336.175130], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Fahrradsternfahrten Berlin</h2>';
        return titleElement;
    })(),
